...
-- Run this SQL script in MySQL/phpMyAdmin to create the database
...
-- Books table for items being reserved
...
-- Reservations table for tracking user bookings
...
-- Comments/Questions table for sidebar
