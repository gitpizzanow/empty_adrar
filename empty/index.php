                ...
                <?php else: ?>
                    <div class="cta-section">
                        ...
                        <div class="action-buttons">
                            ...
                            <?php else: ?>
                                <a href="reservations.php" class="btn btn-primary">Browse Books</a>
                                <a href="my_reservations.php" class="btn btn-secondary">My Reservations</a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php else: ?>
                    ...
                    <?php if (isLoggedIn() && !isAdmin()): ?>
                        <div style="text-align: center; margin-top: 30px;">
                            <a href="reservations.php" class="btn btn-primary">View All Books</a>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </section>
