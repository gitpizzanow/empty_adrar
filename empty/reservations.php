        ...
        <div class="main-content">
            ...
            <div class="search-box">
                <form method="GET" action="">
                    ...
                    <a href="reservations.php" class="btn btn-secondary" style="margin-top: 10px;">Clear Filters</a>
                </form>
            </div>
            ...
            <?php if (empty($books)): ?>
                <div class="alert alert-info">
                    <?php if (!empty($search) || $category_filter > 0): ?>
                        No books found matching your criteria. <a href="reservations.php">View all books</a>.
                    <?php else: ?>
                        ...
                        <div class="book-card">
                            ...
                            <div class="book-info">
                                ...
                                <?php if ($book['available_copies'] > 0): ?>
                                    <button onclick="reserveBook(<?php echo $book['id']; ?>, '<?php echo htmlspecialchars($book['title']); ?>')" 
    ...
    <script>
        function reserveBook(bookId, bookTitle) {
            if (confirm('Are you sure you want to reserve "' + bookTitle + '"?')) {
                ...
                form.method = 'POST';
                form.action = 'process_reservation.php';
